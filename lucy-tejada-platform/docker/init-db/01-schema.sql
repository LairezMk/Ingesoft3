...
INSERT INTO users (id, email, password_hash, role, status, must_change_password, is_active)
VALUES (
  uuid_generate_v4(),
  'admin@lucytejada.gov.co',
...
('institution_name', 'Centro Cultural Lucy Tejada', 'Nombre de la institución', TRUE),
('institution_address', 'Carrera 10 No. 16-60, Pereira, Risaralda', 'Dirección de la institución', TRUE),
('institution_phone', '(606) 311 6121', 'Teléfono principal', TRUE),
('institution_email', 'contacto@lucytejada.gov.co', 'Email de contacto', TRUE),
('institution_website', 'https://www.lucytejada.gov.co', 'Sitio web', TRUE),
('academic_period_current', '2024-1', 'Período académico actual', TRUE),
('max_login_attempts', '5', 'Intentos máximos de login', FALSE),
('session_timeout_minutes', '60', 'Timeout de sesión en minutos', FALSE),
('password_min_length', '8', 'Longitud mínima de contraseña', FALSE),
('data_retention_years', '10', 'Años de retención de datos según Ley 1581', FALSE);

-- Escenarios del Centro Cultural
INSERT INTO venues (code, name, type, capacity, area, floor, building, description, amenities, hourly_rate, daily_rate) VALUES
('TEA-001', 'Teatro Lucy Tejada', 'TEATRO', 500, 800.00, 1, 'Edificio Principal', 'Teatro principal con capacidad para 500 personas', ARRAY['Aire acondicionado', 'Sistema de sonido', 'Iluminación profesional', 'Camerinos', 'Acceso para discapacitados'], 500000.00, 3000000.00),
('AUD-001', 'Auditorio Rodrigo Arenas Betancur', 'AUDITORIO', 200, 300.00, 2, 'Edificio Principal', 'Auditorio para conferencias y presentaciones', ARRAY['Proyector', 'Sistema de sonido', 'Aire acondicionado', 'Wifi'], 200000.00, 1200000.00),
('SAL-001', 'Sala de Ensayo A', 'SALA_ENSAYO', 30, 80.00, 3, 'Edificio Anexo', 'Sala de ensayo para danza y teatro', ARRAY['Espejos', 'Barras de ballet', 'Piso de madera', 'Ventiladores'], 50000.00, 300000.00),
('SAL-002', 'Sala de Ensayo B', 'SALA_ENSAYO', 25, 60.00, 3, 'Edificio Anexo', 'Sala de ensayo para música', ARRAY['Aislamiento acústico', 'Piano', 'Atriles'], 60000.00, 350000.00),
('GAL-001', 'Galería de Arte', 'GALERIA', 100, 200.00, 1, 'Edificio Principal', 'Espacio para exposiciones de arte', ARRAY['Iluminación especial', 'Paredes modulares', 'Aire acondicionado'], 150000.00, 900000.00),
('MUL-001', 'Salón Multiusos', 'SALON_MULTIUSOS', 80, 120.00, 2, 'Edificio Anexo', 'Espacio versátil para diferentes actividades', ARRAY['Mobiliario modular', 'Proyector', 'Pantalla'], 80000.00, 500000.00);

-- Programas formativos iniciales
INSERT INTO formative_programs (code, name, description, area, level, duration_weeks, hours_per_week, max_students, min_age, max_age, objectives, competencies) VALUES
('DAN-INI', 'Danza - Iniciación', 'Programa de iniciación a la danza para principiantes', 'DANZA', 'INICIACION', 16, 4, 25, 6, 12,
ARRAY['Desarrollar coordinación motriz', 'Introducir conceptos básicos de danza', 'Fomentar la expresión corporal'],
ARRAY['Coordinación básica', 'Ritmo', 'Expresión corporal']),
('DAN-BAS', 'Danza - Básico', 'Programa básico de danza contemporánea', 'DANZA', 'BASICO', 20, 6, 20, 8, 18,
ARRAY['Perfeccionar técnica de danza', 'Desarrollar coreografías básicas', 'Fortalecer expresión artística'],
ARRAY['Técnica de danza', 'Coreografía básica', 'Interpretación']),
('MUS-INI', 'Música - Iniciación', 'Introducción a la música y lectura musical', 'MUSICA', 'INICIACION', 16, 3, 30, 6, 99,
ARRAY['Aprender lectura musical básica', 'Desarrollar oído musical', 'Conocer instrumentos básicos'],
ARRAY['Lectura musical', 'Ritmo', 'Apreciación musical']),
('MUS-BAS', 'Música - Básico Instrumental', 'Formación instrumental básica', 'MUSICA', 'BASICO', 24, 4, 15, 8, 99,
ARRAY['Dominar técnica instrumental básica', 'Interpretar repertorio sencillo', 'Desarrollar práctica de conjunto'],
ARRAY['Técnica instrumental', 'Lectura avanzada', 'Ensamble']),
('TEA-INI', 'Teatro - Iniciación', 'Introducción a las artes escénicas', 'TEATRO', 'INICIACION', 16, 4, 25, 8, 99,
ARRAY['Desarrollar expresión corporal y vocal', 'Introducir técnicas de actuación', 'Fomentar trabajo en equipo'],
ARRAY['Expresión corporal', 'Voz y dicción', 'Improvisación']),
('TEA-BAS', 'Teatro - Básico', 'Formación básica en actuación', 'TEATRO', 'BASICO', 20, 6, 20, 12, 99,
ARRAY['Perfeccionar técnicas de actuación', 'Desarrollar construcción de personaje', 'Participar en montajes teatrales'],
ARRAY['Actuación', 'Construcción de personaje', 'Trabajo escénico']),
('AVI-INI', 'Artes Visuales - Iniciación', 'Introducción a las artes visuales', 'ARTES_VISUALES', 'INICIACION', 16, 3, 20, 6, 99,
ARRAY['Explorar técnicas básicas de dibujo y pintura', 'Desarrollar creatividad visual', 'Conocer materiales artísticos'],
ARRAY['Dibujo básico', 'Color', 'Composición']),
('AVI-BAS', 'Artes Visuales - Básico', 'Formación básica en artes plásticas', 'ARTES_VISUALES', 'BASICO', 20, 4, 15, 10, 99,
ARRAY['Dominar técnicas de dibujo y pintura', 'Explorar diferentes medios artísticos', 'Desarrollar propuesta artística personal'],
ARRAY['Técnicas pictóricas', 'Escultura básica', 'Composición avanzada']);
